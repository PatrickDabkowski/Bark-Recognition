...
Original file is located at
    https://colab.research.google.com/drive/1sxw9o8qgyHZwqrhFtpF3sBSaoAJrtXqJ
"""
...
if __name__ == '__main__':
    ...
    train_loader = torch.utils.data.DataLoader(train_dataset, batch_size= 16, shuffle=True, num_workers= 32)
    test_loader = torch.utils.data.DataLoader(test_dataset, batch_size= 16, shuffle=True, num_workers= 32)
    ...
    model = nn.Sequential(
        ...
        nn.Dropout(p=0.5),
        nn.Flatten(),
        nn.Linear(in_features= 102400, out_features=3),
        nn.Softmax(dim=1))
